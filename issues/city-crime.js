...
export default {
  ...
  quiz: {
    ...
    questions: [
      ...
      { key: "violentVictim", text: "Have you been the victim of a violent crime in one of these cities in the past 5 years?",
        options: [ { label: "Yes", w: 30 }, { label: "No", w: 0 } ] },
      { key: "propertyVictim", text: "Property crime — car break-in, package or phone theft — in the past 5 years? (This footprint is real, especially in San Francisco.)",
        options: [ { label: "Yes", w: 15 }, { label: "No", w: 0 } ] },
