...
export default {
  ...
  quiz: {
    ...
    questions: [
      ...
      { key: "industry", text: "Do you — or does an immediate family member — work for a gas utility, appliance maker, or restaurant that cooks on gas?",
        options: [ { label: "Yes, I do", w: 20 }, { label: "An immediate family member does", w: 10 }, { label: "No", w: 0 } ] },
